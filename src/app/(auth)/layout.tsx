    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 to-teal-700 p-12 flex-col justify-between">
        ...
        <div>
          ...
          <p className="text-emerald-100 text-lg">Join thousands of travelers exploring the beautiful archipelago through our curated tour experiences.</p>
        </div>
        <p className="text-emerald-200 text-sm">© {new Date().getFullYear()} MeetAndGo. All rights reserved.</p>
      </div>
