        ...
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-emerald-50 rounded-lg">
              <p className="text-sm text-emerald-700">Final Price</p>
              <p className="text-xl font-bold text-emerald-900">{request.finalPrice ? formatPrice(Number(request.finalPrice)) : "Not set"}</p>
            </div>
          </div>
