                    ...
                    >
                      ...
                      <div className="text-right">
                        {isOpenTrip && dep.pricePerPerson && (
                          <p className="font-semibold text-emerald-600">{formatPrice(Number(dep.pricePerPerson))}<span className="text-sm font-normal text-slate-500">/person</span></p>
                        )}
                      </div>
                    </label>
                  );
          ...
          <Card variant="bordered">
            ...
            <CardContent>
              <textarea
                ...
                className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none resize-none"
                rows={3}
