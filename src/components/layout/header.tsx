          ...
          <div className="hidden md:flex items-center gap-3">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link href="/register" className="px-4 py-2 text-sm font-medium text-white bg-emerald-600 rounded-lg hover:bg-emerald-700 transition-colors">
                  Register
                </Link>
              </>
            )}
            ...
            <div className="flex flex-col gap-1">
              ...
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <Link href="/register" onClick={() => setMobileMenuOpen(false)} className="px-4 py-3 rounded-lg text-sm font-medium text-white bg-emerald-600 hover:bg-emerald-700 text-center">
                    Register
                  </Link>
                </>
              )}
