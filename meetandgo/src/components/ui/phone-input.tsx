    ...
    <div className={className}>
      ...
      <div className="flex">
        <select
          ...
          disabled={disabled}
          className="px-3 py-2.5 rounded-l-lg border border-r-0 border-slate-200 bg-slate-50 text-sm font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500"
        >
