      ...
      <form onSubmit={handleSearch} className="flex gap-2 max-w-xl mx-auto">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 rounded-lg border border-slate-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 outline-none"
          />
        </div>
      ...
      <div className="flex flex-wrap gap-2 justify-center">
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
            !currentType ? "bg-primary-600 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"
          }`}
        >
          All Packages
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
            currentType === "open" ? "bg-primary-600 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"
          }`}
        >
          Open Trip
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
            currentType === "private" ? "bg-primary-600 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"
          }`}
        >
          Private Trip
        </button>
        ...
        <div className="flex items-center gap-2 justify-center flex-wrap">
          ...
          {currentSearch && (
            <span className="inline-flex items-center gap-1 px-2 py-1 bg-primary-100 text-primary-700 rounded-full text-sm">
              ...
              <button onClick={() => { setSearch(""); updateParams("search", undefined); }} className="hover:text-primary-900">
                <X className="w-3 h-3" />
              </button>
            </span>
          )}
          {currentType && (
            <span className="inline-flex items-center gap-1 px-2 py-1 bg-primary-100 text-primary-700 rounded-full text-sm">
              ...
              <button onClick={() => updateParams("type", undefined)} className="hover:text-primary-900">
                <X className="w-3 h-3" />
              </button>
            </span>
          )}
          {currentLocation && (
            <span className="inline-flex items-center gap-1 px-2 py-1 bg-primary-100 text-primary-700 rounded-full text-sm">
              ...
              <button onClick={() => updateParams("location", undefined)} className="hover:text-primary-900">
                <X className="w-3 h-3" />
              </button>
            </span>
          )}
          {(currentMinPrice || currentMaxPrice) && (
            <span className="inline-flex items-center gap-1 px-2 py-1 bg-primary-100 text-primary-700 rounded-full text-sm">
              ...
              <button onClick={() => { updateParams("minPrice", undefined); updateParams("maxPrice", undefined); }} className="hover:text-primary-900">
                <X className="w-3 h-3" />
              </button>
            </span>
          )}
