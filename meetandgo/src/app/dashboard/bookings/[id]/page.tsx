      ...
      {booking.status === "PAYMENT_RECEIVED" && (
        <Card variant="bordered" className="border-primary-200 bg-primary-50">
          <CardContent className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-primary-800">Payment Confirmed</h3>
              <p className="text-primary-700">Thank you! Your payment has been received. We're processing your booking.</p>
            </div>
          </CardContent>
        </Card>
      )}
        ...
        <CardContent>
          <div className="flex gap-4">
            ...
            <div className="space-y-2">
              ...
              <Link href={`/packages/${pkg.slug}`} className="text-sm text-primary-600 hover:underline">View package details →</Link>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-primary-600">{formatPrice(Number(booking.totalAmount))}</p>
            </div>
          </div>
          {isPending && !isExpired && (
