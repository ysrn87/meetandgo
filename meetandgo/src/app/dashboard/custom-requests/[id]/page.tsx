      ...
      {isAccepted && request.finalPrice && (
        <Card variant="bordered" className="border-primary-200 bg-primary-50">
          <CardContent className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-primary-800">Ready to Book!</h3>
              <p className="text-primary-700">Your custom tour has been confirmed at <strong>{formatPrice(Number(request.finalPrice))}</strong>. Please proceed with payment to secure your trip.</p>
              <p className="text-sm text-primary-600 mt-2">Transfer to: Bank BCA 1234567890 a/n PT MeetAndGo Indonesia</p>
            </div>
          </CardContent>
        </Card>
      )}
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-primary-50 rounded-lg">
              <p className="text-sm text-primary-600">Final Price</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                {request.tourGuide.phone && (
                  <a href={`tel:${request.tourGuide.phone}`} className="text-sm text-primary-600 hover:underline">
                    {request.tourGuide.phone}
                  </a>
                )}
              </div>
