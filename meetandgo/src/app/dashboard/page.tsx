    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        {bookings.length > 0 ? (
          ...
          <Card variant="bordered" className="text-center py-8">
            ...
            <Link href="/packages" className="text-primary-600 font-medium mt-2 inline-block">Browse packages</Link>
          </Card>
        )}
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/dashboard/custom-requests" className="text-primary-600 text-sm font-medium flex items-center gap-1">
            View all <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
        {customRequests.length > 0 ? (
          ...
          <Card variant="bordered" className="text-center py-8">
            ...
            <Link href="/custom-request" className="text-primary-600 font-medium mt-2 inline-block">Create a request</Link>
          </Card>
        )}
      </div>
    </div>
